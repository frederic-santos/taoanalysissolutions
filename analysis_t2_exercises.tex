...
\begin{exo}{12.1.3}{Let $X$ be a set, and let
    $d : X \times X → [0, \infty)$ be a function. With respect to
    Definition 12.1.2, give an example of a pair $(X,d)$ which obeys
    to the following properties...}

  We have the following cases for the pair $(X,d)$:
  \begin{enumerate}[label=(\alph*)]
