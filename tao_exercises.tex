...
\bigskip
\begin{exo}{9.1.10}{If $X$ is a non-empty subset of $\R$, show that
...
\bigskip
\begin{exo}{9.1.11}{Show that if $X$ is a bounded subset of $\R$, then
    the closure $\adh{X}$ is also bounded.}
