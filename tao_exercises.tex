...
\begin{exo}{11.5.2}{Prove Proposition 11.5.6. (Hint: use Theorem
  ...
  Saying that $f$ is piecewise continuous means that there exists a
  partition $\P$ of $I$ such that $f|_J$ is continuous on each
  interval $J \in \P$. Actually, we can even define, for each $J \in
  \P$, a function $g_J : I \to \rr$ by:
  \[
    \begin{cases}
    ...
    \end{cases}
  \]
  By Theorem 11.5.1(g), we know that, for all $J \in \P$, $g_J$ is
